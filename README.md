...
* 壁の入力は、面材を張る**軸組材の一覧**です。1 本ごとに **向き**（縦材＝柱・間柱など／横材＝横架材・受け材など）・**名前**（計算書にそのまま出ます）・**材心の位置**（壁の左下が原点。縦材は X、横材は Y）・**見付け幅**（面材の側から見た材の幅）を入れます。等間隔とは限らない実際の軸組（開口の脇に寄せた縦材、面材の継目に入れる受け材、まぐさ・窓台）をそのまま書けます
